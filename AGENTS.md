# AGENTS.md — notes for Codex sessions on this repo

Context & conventions for future Codex runs working on Convoy.
...
├── plugin/            Codex plugin: commands + agents (markdown)
